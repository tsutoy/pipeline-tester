...
function bumpVersion(type) {
    const { stdout } = shell_1.shell.exec(`yarn version --${type} --no-commit-hooks --no-git-tag-version`, { onErrorMessage: `failed to bump ${github_1.context} version.` });
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        shell_1.shell.exec(`echo "version=${version}" >> $GITHUB_OUTPUT`, {
